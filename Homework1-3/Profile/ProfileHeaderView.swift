...
class ProfileHeaderView: UIView {
    ...
    let fullShowStatus: UIButton = {
        ...
        showStatus.setTitle("Установить статус", for: .normal)
    ...
    private func initialLayout() {
        ...
        [
            ...
            fullLabelName.leadingAnchor.constraint(equalTo: fullImageView.trailingAnchor, constant: 20),
            fullLabelName.topAnchor.constraint(equalTo: self.topAnchor, constant: 27),
            fullLabelName.trailingAnchor.constraint(greaterThanOrEqualTo: self.trailingAnchor, constant:  -16),
