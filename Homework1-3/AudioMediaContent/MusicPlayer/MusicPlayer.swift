...
class MusicPlayer: UIViewController {
    ...
    private func fillLibrary() {
        library.removeAll()
        library.append(("проигрывается песня 1", URL(fileURLWithPath: Bundle.main.path(forResource: "music1", ofType: "mp3")!)))
        library.append(("проигрывается песня 2", URL(fileURLWithPath: Bundle.main.path(forResource: "music2", ofType: "mp3")!)))
        library.append(("проигрывается песня 3", URL(fileURLWithPath: Bundle.main.path(forResource: "music3", ofType: "mp3")!)))
        library.append(("проигрывается песня 4", URL(fileURLWithPath: Bundle.main.path(forResource: "music4", ofType: "mp3")!)))
        library.append(("проигрывается песня 5", URL(fileURLWithPath: Bundle.main.path(forResource: "music5", ofType: "mp3")!)))
    }
